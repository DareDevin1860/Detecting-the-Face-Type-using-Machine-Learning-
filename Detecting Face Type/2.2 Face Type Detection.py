...
data_file=open('train_data.pickle','rb')#rb for read byte
...
def predict_face(img,points):
    ...
    cv2.putText(img,face_dic[result],(250,27),cv2.FONT_HERSHEY_SIMPLEX,1,(255,255,255),2)
...
while(True):
    ...
    img[0:][0:30]=[0,255,0]
    cv2.putText(img,'FACE TYPE :',(5,27),cv2.FONT_HERSHEY_SIMPLEX,1,(255,255,255),2)
